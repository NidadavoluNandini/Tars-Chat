...
export function ChatShell() {
  ...
  if (authState === undefined) {
    return (
      <div className="grid min-h-screen supports-[min-height:100dvh]:min-h-dvh grid-cols-1 overflow-hidden lg:grid-cols-[360px_1fr]">
  ...
  if (!authState.isAuthenticated) {
    return (
      <main className="flex min-h-screen supports-[min-height:100dvh]:min-h-dvh items-center justify-center p-4">
    ...
    <div className="grid min-h-screen supports-[min-height:100dvh]:min-h-dvh grid-cols-1 overflow-hidden bg-background lg:grid-cols-[360px_1fr]">
      ...
      {showChatPanel ? (
        selectedConversationId ? (
          ...
          <section className="hidden h-full min-h-0 items-center justify-center bg-muted/20 p-6 text-center lg:flex">
            <div className="rounded-2xl border border-border/60 bg-card px-10 py-12 shadow-sm">
